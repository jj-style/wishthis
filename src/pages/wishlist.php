    ...
    <div class="ui container">
        ...
        <div class="ui segments">
            <div class="ui segment">
                ...
                <p>If you found a wish you would like to fulfil:</p>
                <ol>
                    <li>Open the wish <span class="ui tiny horizontal label"><i class="stream icon"></i>Details</span>.</li>
                    <li>Visit the link and purchase through the vendor's site, or an alternative.</li>
                    <li>Please kindly deliver to yourself or contact one of us for a delivery address.</li>
